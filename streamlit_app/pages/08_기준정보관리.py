...
# 권한: ADMIN/QUALITY만 편집 가능
CAN_EDIT = has_role("ADMIN", "QUALITY", "MANAGER")
CAN_EDIT_CODE = has_role("ADMIN")  # §8.1: 코드관리는 ADMIN 전용


def _client() -> httpx.Client:
    return httpx.Client(base_url=BASE_URL, headers=get_auth_headers(), timeout=30.0)
